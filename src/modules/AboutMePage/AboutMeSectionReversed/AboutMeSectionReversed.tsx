...
import {
  ...
  StyledTextWrapper,
  StyledImagesWrapper,
} from './AboutMeSectionReversed.styles';

export const AboutMeSectionReversed = forwardRef((_, ref: ForwardedRef<HTMLElement>) => (
...
AboutMeSectionReversed.displayName = 'AboutMeSectionReversed';
